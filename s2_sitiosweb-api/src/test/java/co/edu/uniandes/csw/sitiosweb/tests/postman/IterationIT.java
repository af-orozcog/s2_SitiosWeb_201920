...
public class IterationIT {
    
    private static final String COLLECTION = "IterationResourceTest.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s2_sitiosweb-api.war")//War del modulo api
                ...
                .addPackage(IterationResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(IterationDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
