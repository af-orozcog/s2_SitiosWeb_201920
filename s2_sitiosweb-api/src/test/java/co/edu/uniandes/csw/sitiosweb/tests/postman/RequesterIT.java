...
import co.edu.uniandes.csw.sitiosweb.resources.RequesterResource;
import java.io.File;
...
public class RequesterIT {
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s2_sitiosweb-api.war")//War del modulo api
                ...
                .addPackage(RequesterResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(RequesterDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
