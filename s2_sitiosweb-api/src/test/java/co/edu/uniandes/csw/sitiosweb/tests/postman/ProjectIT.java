...
import co.edu.uniandes.csw.sitiosweb.resources.ProjectResource;
import java.io.File;
...
/**
 *
 * @author Daniel Galindo Ruiz (d.galindo)
 */
...
public class ProjectIT {
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s2_sitiosweb-api.war")//War del modulo api
                ...
                .addPackage(ProjectResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(ProjectDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
