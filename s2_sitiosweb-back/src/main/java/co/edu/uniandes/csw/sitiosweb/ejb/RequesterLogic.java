...
public class RequesterLogic {
     ...
     * @return Instancia de RequesterEntity con los datos del Requester consultado.
     */
     ...
     * @throws BusinessLogicException si el la instancia con los nuevos datos tiene datos inválidos.
     */
