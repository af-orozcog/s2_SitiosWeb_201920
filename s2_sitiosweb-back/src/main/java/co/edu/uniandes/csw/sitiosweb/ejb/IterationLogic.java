...
public class IterationLogic {
    ...
    public void deleteIteration(Long projectId, Long iterationId) throws BusinessLogicException {
        LOGGER.log(Level.INFO, "Inicia proceso de borrar el review con id = {0} del libro con id = {1}", new Object[] {iterationId, projectId});
        ...
        LOGGER.log(Level.INFO, "Termina proceso de borrar el review con id = {0} del libro con id = {1}",new Object[] {iterationId, projectId});
    }
}
